...
describe.only('sumDigits()', () => {
  it('should return the same output if passed a single digit', () => {
    expect(sumDigits(1)).toBe(1);
  });
  it('should return the total of the passed digits if more than one digit passed', () => {
    expect(sumDigits(99)).toBe(18);
    expect(sumDigits(123)).toBe(6);
  });
  it('should return am integer if passed a decimal number', () => {
